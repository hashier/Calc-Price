...
public class Alc extends Activity implements OnClickListener, View.OnKeyListener {
			...
			public void onClick(View v) {
				...
				if ( (quant1.length() > 0) && (price1.length() > 0) && (per1.length() > 0) ) {
					tmp1 =
						...
						( Float.parseFloat(per1.getText().toString()) / 100 );
				...
				if ( (quant2.length() > 0) && (price2.length() > 0) && (per2.length() > 0) ) {
					tmp2 =
						...
						( Float.parseFloat(per2.getText().toString()) / 100 );
	...
	public boolean onKey(View v, int keyCode, KeyEvent event) {
        if( (price1.length() > 0) && (quant1.length() > 0) && (per1.length() > 0) ||
        		( (price2.length() > 0) && (quant2.length() > 0)  && (per2.length() > 0) ) )
